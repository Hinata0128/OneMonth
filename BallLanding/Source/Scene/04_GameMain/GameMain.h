...
#include "System//02_Singleton//02_SingletonManager//00_NeedleManager//NeedleManager.h"
#include "System//02_Singleton//02_SingletonManager//01_BallManager//BallManager.h"
...
private:
	...
	std::unique_ptr<PointCan> m_pPointCan;
